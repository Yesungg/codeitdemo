        ...
        <div class="comment_enter body">
          <form onSubmit={handleSubmit}>
            <div class="nickName box">
              ...
              <input id="comment_nickname" name="comment_nickname" type="text" placeholder="닉네임을 입력해주세요." value={nickname} onChange={(e) => setNickname(e.target.value)} required />
            </div>
            <div class="comment box">
              <label htmlFor="comment">댓글</label>
              <input id="comment" name="comment" type="text" placeholder="댓글을 입력해주세요." value={comment} onChange={(e) => setComment(e.target.value)} required />
            </div>
            <div class="password box">
              <label htmlFor="password">비밀번호 생성</label>
              <input id="password" name="password" type="password" placeholder="댓글 비밀번호를 입력해주세요." value={password} onChange={(e) => setPassword(e.target.value)} required />
            </div>
